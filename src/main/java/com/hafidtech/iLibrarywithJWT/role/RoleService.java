...
import com.hafidtech.iLibrarywithJWT.exception.RoleAlreadyExistException;
...
import com.hafidtech.iLibrarywithJWT.user.IUserService;
...
public class RoleService implements IRoleService {
    ...
    public User removeUserFromRole(Long userId, Long roleId) {
        ...
        if (role.isPresent() && role.get().getUsers().contains(user.get())) {
            role.get().removeAllUsersFromRole(user.get());
